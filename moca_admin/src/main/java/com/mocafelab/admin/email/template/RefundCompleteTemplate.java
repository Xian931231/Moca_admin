...
public class RefundCompleteTemplate extends Template {
	...
	public RefundCompleteTemplate() {
		setTitle("[MoCAFE] 환불이 정상 처리되었습니다.");
	}
									...
									content.append("<div class='password_text_box' style='padding:60px; line-height:30px; border: 1px solid #adadad;'>");
										content.append("<div class='password_issuance_box' style='margin-bottom: 1em;'>");
											content.append("<p style='margin-bottom: 0; line-height:40px;'>");
												...
												content.append("광고비 환불이 정상 처리되어 안내드립니다.");
											content.append("</p>");
										content.append("</div>");
										content.append("<div class='account_box' style='width:680px; height:160px; background:#f9f9f9; display:flex; flex-direction:column; justify-content:center; line-height:30px;'>");
											content.append("<p style='margin-left: 21px; font-weight: bold;'>");
												content.append("광고명: " + sgName + "<br>");
												content.append("환불 금액: " + pay + " 원<br>");
												content.append("환불 계좌: " + bankInfo + "<br>");
