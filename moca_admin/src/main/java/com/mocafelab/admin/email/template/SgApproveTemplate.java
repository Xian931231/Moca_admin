...
public class SgApproveTemplate extends Template {
	...
	public SgApproveTemplate() {

	}
	
	// Y - 승인 / N - 거부
	public SgApproveTemplate(String status) {
		if(status.equals("Y")) {
			setTitle("[MoCAFE] 광고 승인이 완료되었습니다.");
			setContent1("요청하신 광고 승인이 정상 처리되었습니다.");
			setContent2("모카페 플랫폼의 많은 이용 부탁드립니다.");
		} else if(status.equals("N")) {
			setTitle("[MoCAFE] 광고 승인이 거부되었습니다.");
			setContent1("요청하신 광고 승인이 거부되었습니다.");
			setContent2("자세한 사항은 담당자에게 문의 부탁드립니다.");
		}
	}
