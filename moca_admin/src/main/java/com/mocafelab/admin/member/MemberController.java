...
public class MemberController {
	...
	public Map<String, Object> memberLoginByStaff(RequestMap reqMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Map<String, Object> param = reqMap.getMap();
		
		CommonUtil.checkNullThrowException(param, "member_id");
		
		return memberService.memberLoginByStaff(param, request, response);
	}
