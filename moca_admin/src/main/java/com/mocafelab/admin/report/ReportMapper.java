...
public interface ReportMapper {
	...
	// 광고주의 광고별 노출수 조회
	public int getStartTotalCountByDemand(Map<String, Object> param);
	public int getEndTotalCountByDemand(Map<String, Object> param);
	public int getMiddleTotalCountByDemand(Map<String, Object> param);
	...
	// 매체사의 상품별 노출수 조회 
	public int getStartTotalCountBySupply(Map<String, Object> param);
	public int getEndTotalCountBySupply(Map<String, Object> param);
	public int getMiddleTotalCountBySupply(Map<String, Object> param);
	...
	// 매체사가 소유한 디바이스 목록 조회
	public List<Map<String, Object>> getDeviceListBySupplyMember(Map<String, Object> param);
	...
	public int getStartTotalCountByProduct(Map<String, Object> param);
	public int getEndTotalCountByProduct(Map<String, Object> param);
	public int getMiddleTotalCountByProduct(Map<String, Object> param);
	
	public List<Map<String, Object>> getReportListByAreaMap(Map<String, Object> param);
	
	// 지역별 노출수 조회
	public List<Map<String, Object>> getStartTotalCountByArea(Map<String, Object> param);
	public List<Map<String, Object>> getEndTotalCountByArea(Map<String, Object> param);
	public List<Map<String, Object>> getMiddleTotalCountByArea(Map<String, Object> param);
