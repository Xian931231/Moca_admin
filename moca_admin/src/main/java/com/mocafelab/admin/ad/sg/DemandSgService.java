package com.mocafelab.admin.ad.sg;
...
import com.mocafelab.admin.ad.schedule.DemandScheduleMapper;
import com.mocafelab.admin.ad.schedule.ScheduleMapper;
import com.mocafelab.admin.common.CommonMapper;
import com.mocafelab.admin.enums.ModifyHistory;
import com.mocafelab.admin.enums.PayType;
import com.mocafelab.admin.enums.SgPageSize;
import com.mocafelab.admin.enums.SgRatio;
import com.mocafelab.admin.file.S3Service;
import com.mocafelab.admin.member.DemandMemberService;
import com.mocafelab.admin.product.ProductMapper;
...
public class DemandSgService {
	...
	public Map<String, Object> addSgSchedule(Map<String, Object> param) throws Exception {
		...
		List<Map<String, Object>> scheduleList = CommonUtil.jsonArrayToList((String) param.get("schedule_list"));
